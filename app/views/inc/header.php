...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/view_order.css">
        ...
        <div class="container">
            ...
            <div class="menu text-right">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo URLROOT; ?>/pages/view_order">Order List</a>
                    </li>
                    <li>
                        <a href="<?php echo URLROOT; ?>/pages/profile">Profile</a>
                    </li>
                    <li>
                        <a href="<?php echo URLROOT; ?>/pages/index">Logout</a>
                    </li>
